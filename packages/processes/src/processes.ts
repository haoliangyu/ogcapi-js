...
export class ProcessesService extends Service {
  ...
  async getProcess(
    ...
    const result: IProcess = await request({ url, signal: options.signal, params: options.params });
    return result;
  }
  ...
  async executeProcess<T extends TProcessRequestExecutionMode>(
    ...
    const result = await request({ url, headers, params, signal: options.signal, method: 'POST' });
  ...
  async getJobs(options: IGetJobsOptions = {}): Promise<IJobsResponse> {
    ...
    const result: IJobsResponse = await request({ url, params, signal: options.signal });
    return result;
  }
  ...
  async getJob(
    ...
    const params: IRequestParams = Object.assign({}, options.params);
    const result: IJobInfo = await request({ url, params, signal: options.signal });
    return result;
  }
  ...
  async getJobResults(
    ...
    const url: string = `${this.baseUrl}/jobs/${jobId}`;
    const params: IRequestParams = Object.assign({}, options.params);
    const result: TJobResult = await request({ url, params, signal: options.signal });
    return result;
  }
  ...
  async dismissJob(
    ...
    const url: string = `${this.baseUrl}/jobs/${jobId}`;
    const params: IRequestParams = Object.assign({}, options.params);
    const result: IJobInfo = await request({ url, params, signal: options.signal, method: 'DELETE' });
    return result;
  }
}
