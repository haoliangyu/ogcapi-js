...
- Improve npm package keywords

## 1.3.0 - 2025-11-23

### Added

- New support to [Records API](https://ogcapi.ogc.org/records/) ([#72](https://github.com/haoliangyu/ogcapi-js/pull/72))
...
- Fix typing file output path ([#70](https://github.com/haoliangyu/ogcapi-js/pull/70))
